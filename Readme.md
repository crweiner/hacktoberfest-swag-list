...
Also new for 2022, the Hacktoberest Swag List is now powered by [MkDocs](https://www.mkdocs.org/) instead of Jekyll. This means that the Swag List is more easily searchable, can support lite and dark modes, is still written in Markdown so everyone can participate no matter their skill level, and is easier to extend!
...
[The Hacktoberfest Swag List site](https://hacktoberfestswaglist.com) and [GitHub repo](https://github.com/crweiner/hacktoberfest-swag-list) are here to showcase all of the amazing companies that go above and beyond by offering their swag for the holiday. **The goal of this project is to connect contributors to open-source projects that they might not have heard about before and drive traffic toward organizations that celebrate Hacktoberfest and can use a little more help.**
