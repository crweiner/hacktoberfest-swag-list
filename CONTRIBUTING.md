...
Make a fork of this repo and add the details for what company and swag you find in the [Readme.md](../master/README.md). If you are adding a new company, be sure to add your company in two places:
