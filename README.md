...
- **Notes**:
  ...
  - Although they added `Hacktoberfest` topic in their repo, they will consider only PRs whose issue is labeled with `Hacktoberfest` above for their unique swag.
...
- **Notes**: Check out [their blog](https://blog.flyte.org/meet-flyte-hacktoberfest-2021) for more info. The first 15 contributors will get a mug irrespective of the number of merged pull requests.
...
- **Notes**: This year, Hasura is offering two ways to earn their exclusive swag
  - Fix at least on issue labeled `Hacktoberfest`.
  - Participate in their Hasura Tips & Tricks contest on Twitter. [More details here](https://hasura.io/blog/celebrating-open-source-with-hasura/).
  - You only have until November 14th to earn Hasura's unique swag.
...
- **Requirements**: Merge one PR successfully to any of the K6 repositories and you will receive an [awesome swag pack](https://twitter.com/yusuftayman/status/1423203725229936648/photo/1)!
...
- **How to sign up**: Tweet about your contribution and mention [@NativeScript](https://twitter.com/NativeScript), then DM them with your address to get free swag.
...
- **Requirements**:  Three or more open and valid pull requests to the repository.
- **How to sign up**: No additional sign-up is required. You can join the [devrel slack](https://docs.symbl.ai/docs/changelog/#connect-with-us-on-slack-) channel
- **Issues**:
...
- **Notes**:
  - Read over [ToolJet's blog post](https://blog.tooljet.io/Hacktoberfest-2021/)
  - Documentation contribution is also accepted. More info available [here](https://blog.tooljet.io/Hacktoberfest-2021/)
...
- **Requirements**: Contribute to [open Hacktoberfest issues](https://Hacktoberfest.appwrite.io/), build a demo app, rite a blog post or reate a tutorial.
  - **At least 1** accepted pull request in any eligible repository under the [Appwrite](https://github.com/appwrite/) organization with the `Hacktoberfest` topic.
  - Swag Tiers
    - **1 accepted PR**   - OG Appwrite Stickers
...
- **Swag**: A Hasura swag box
- **How to sign up**: Contribute one PR or participate in the [Hasura Tips & Tricks contest](https://hasura.io/blog/celebrating-open-source-with-hasura/)
- **Notes**: This year, Hasura is offering two ways to earn their exclusive swags
  - Fix at least on issue labeled `Hacktoberfest`.
  - Participate in their Hasura Tips & Tricks contest on Twitter. [More details here](https://hasura.io/blog/celebrating-open-source-with-hasura/).
  -You only have until November 14th to earn Hasura's unique swag.
...
- **Requirements**: 1 approved pull request for `Hacktoberfest` issue in one of [PayPal's repos](https://github.com/paypal)
...
- **Requirements**:  Create one or more valid pull requests on the [ToolJet](https://github.com/ToolJet/ToolJet)
...
- **Requirements**:  Create three or more valid pull requests on the [ToolJet](https://github.com/ToolJet/ToolJet)
