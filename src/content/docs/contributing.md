---
title: Contributing
description: Learn how to add a company to the Hacktoberfest Swag List.
---
...
- **Requirements**: What do I have to complete? Are there different requirements per swag item? Are the PRs merged or just submitted?
    - Use four spaces for nested bullet points.
...
Please make sure you are always making changes in the Markdown docs located in `src/content/docs/` and do not edit the HTML that Astro builds in the `dist/` directory.
