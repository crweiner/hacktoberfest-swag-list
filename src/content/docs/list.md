...
Hacktoberfest is about making meaningful contributions to open source projects.
:::

Hacktoberfest works differently in 2026. The official event is now [300+ community-hosted Fests plus an online event](https://hacktoberfest.com/), all about building with open source AI, and it no longer counts pull requests. Start by [finding a Fest near you](https://hacktoberfest.com/fests/), then [read the official FAQ](https://hacktoberfest.com/questions/) to see how to take part.

Plenty of open-source organizations still celebrate October with their own contribution programs and swag. That is what this list is for.

See [**Contributing**](/contributing/) to see how to format your pull request to add a company's swag to the List!
