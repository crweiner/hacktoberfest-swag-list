...
description: Find organizations offering their own Hacktoberfest swag and learn how to contribute meaningfully.
template: splash
hero:
  title: Hacktoberfest Swag List
  tagline: Find open-source projects celebrating Hacktoberfest with their own swag, then help them with meaningful contributions.
  image:
    html: |
      <picture>
        <source srcset="/img/HF-Icon-Color-Light.png" media="(prefers-color-scheme: dark)">
        <img src="/img/HF-Icon-Color-Dark.png" alt="Hacktoberfest logo" width="320" height="320">
      </picture>
  actions:
    - text: View the Swag List
      link: /list/
      icon: right-arrow
    - text: Add a Company
      link: /contributing/
...
<div class="hfsl-home-paths">
  <a class="hfsl-home-path" href="/list/">
    <strong>Find companies offering swag</strong>
    <span>Browse the current list by company, swag type, requirements, signup details, and issue links.</span>
  </a>
  <a class="hfsl-home-path" href="/contributing/">
    <strong>Add a company</strong>
    <span>Use the contributor guide to make a small Markdown edit and open a pull request.</span>
  </a>
  <a class="hfsl-home-path" href="https://github.com/crweiner/hacktoberfest-swag-list">
    <strong>Help maintain the list</strong>
    <span>Fix links, improve company details, or help first-time contributors get unstuck.</span>
  </a>
</div>
...
This year, the Swag List is a little different, so be sure to read about how to [Contribute before submitting a PR](/contributing/).

Ready to browse? [Open the 2025 Hacktoberfest Swag List](/list/).
