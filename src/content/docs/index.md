...
hero:
  ...
  image:
    dark: ../../assets/HF-Icon-Color-Light.svg
    light: ../../assets/HF-Icon-Color-Dark.svg
  actions:
    - text: View the 2025 Swag List
      link: /list/
      icon: right-arrow
      variant: primary
...
Remember, [low-code or no-code contributions are encouraged](https://hacktoberfest.com/participation/), so everyone has a chance, regardless of skill level, to contribute and make open-source projects even better!
:::
...
### [Click here to be taken to the 2025 Hacktoberfest Swag List!](/list/)
